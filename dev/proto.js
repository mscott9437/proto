...
this.onclick = function() {
	...
	document.querySelector('#response').textContent = 'Hello and Welcome.';

}

}}

customElements.define('contact-button', ContactButton, { extends: 'button' });
